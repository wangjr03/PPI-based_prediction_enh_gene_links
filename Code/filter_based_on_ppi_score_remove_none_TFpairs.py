...
-p: the ppi file, default = '/Users/hbb/Dropbox/PPI_project/Data/PPI/STRING_v11_PPI_score.txt'
...
def Parser():
   ...
   parser.add_argument('-p', help = 'the ppi file', default = '/Users/hbb/Dropbox/PPI_project/Data/PPI/STRING_v11_PPI_score.txt')
